...
for gallery in gallery_list:
    ...
    with open(gallery + '/captions.txt','rb') as captions_f:
        ...
        for img in img_list:
            ...
            gallery_f.write('''<a href="./photos/galleries/''' + gallery_path + '''/photos/''' + img_name + '''" title="''' + caption + '''"><img src="./photos/galleries/''' + gallery_path + '''/thumbnails/''' + img_name + '''" alt="''' + caption + '''"></a>''')
